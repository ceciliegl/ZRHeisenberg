    ...
    if folder >= 0 and folder < 10:
        if os.path.exists("Run00" + str(folder)):
            ...
            for line in outfile:
                ...
                if (len(linewords) > 0):
                    words.append(linewords[-1])
            print("Run00" + str(folder) + "     %4s    %4s      %+2.2f    %+2.2f    %+2.2f     %+2.2f     %+2.2f      %+2.2f"\
             % (words[0], words[1], float(words[2]), float(words[3]), float(words[4]), float(words[5]), float(words[6]), float(words[7])))
            folder += 1
            folders += 1
        else:
            folder += 1
        ...
        if os.path.exists("Run0" + str(folder)):
            ...
            for line in outfile:
                ...
                if (len(linewords) > 0):
                    words.append(linewords[-1])
            print("Run0" + str(folder) + "     %4s    %4s      %+2.2f    %+2.2f    %+2.2f     %+2.2f     %+2.2f      %+2.2f"\
             % (words[0], words[1], float(words[2]), float(words[3]), float(words[4]), float(words[5]), float(words[6]), float(words[7])))
            folder += 1
            folders += 1
        else:
        ...
        if os.path.exists("Run" + str(folder)):
            ...
            for line in outfile:
                ...
                if (len(linewords) > 0):
                    words.append(linewords[-1])
            print("Run" + str(folder) + "     %4s    %4s      %+2.2f    %+2.2f    %+2.2f     %+2.2f     %+2.2f      %+2.2f"\
             % (words[0], words[1], float(words[2]), float(words[3]), float(words[4]), float(words[5]), float(words[6]), float(words[7])))
            folder += 1
            folders += 1
        else:
